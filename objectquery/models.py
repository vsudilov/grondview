...
class Photometry(models.Model):
  ...
  MAG_KRON = models.FloatField(null=True)
  MAG_KRON_ERR = models.FloatField(null=True)
  MAG_CALIB = models.FloatField(null=True)
  MAG_CALIB_ERR = models.FloatField(null=True)
