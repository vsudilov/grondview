...
urlpatterns = patterns('',
    ...
    url(r'^sources/tag/$',accounts.views.TagView.as_view() ),
    url(r'^sources/name/$',accounts.views.NameView.as_view() ),
    url(r'^sources/export/csv/(?P<sourceID>[\w:\.+-]+)/$', grondview.views.ExportView.as_view() ),
